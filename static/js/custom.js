...
$(function() {
 "use strict";
    ...
    function responsive_dropdown () {
        ...
        if (x.matches) { // If media query matches
            ...
            $(".menu-toggle").on("click", function(){
                ...
                // $(".nav-link").slideToggle("close")
                $(".nav-link").off("click").on("click", function() {
                    $(".menu-toggle").toggleClass("active");
                    $(".menu").slideToggle("close");
                });
            });
    ...
    if ($(".coins-counter-loop").length > 0) {
        var your_date = '2022-01-14 14:00:00';
        var second = 1000,
            minute = second * 60,
            hour = minute * 60,
            day = hour * 24;
    ...
    /* -------- Countdown Timer ------- */
    if ($(".coins-counter-loop-two").length > 0) {
        var your_date = '2022-01-14 14:00:00';
        var second = 1000,
            minute = second * 60,
            hour = minute * 60,
    ...
    if ($(".coins-progress").length > 0) {
        ...
        function coins_progress(x) {
            $(".coins-progress span").each(function () {
                $(this).animate({
                    width: $(this).attr("data-progress") + "%",
                },1000
                );
                $(this).text($(this).attr("data-progress") * 42000000 + '\xa0\xa0' + "MNT" + '\xa0\xa0' + '/' + '\xa0\xa0' + 4200000000 + '\xa0\xa0' + 'MNT')
            });
        };
    }
});
...
if ($("#map").length > 0) {
    function initMap() {
      ...
      const map = new google.maps.Map(document.getElementById("map"), {
        center: { lat: 41.2056821, lng: -73.9980279 },
        zoom: 12,
        styles: [
          { elementType: "geometry", stylers: [{ color: "#d4e8fd" }] },
          { elementType: "labels.text.stroke", stylers: [{ color: "#ffffff" }] },
          { elementType: "labels.text.fill", stylers: [{ color: "#024b94" }] },
          {
            featureType: "administrative.locality",
            elementType: "labels.text.fill",
            stylers: [{ color: "#024b94" }],
          },
          {
            featureType: "poi",
            elementType: "labels.text.fill",
